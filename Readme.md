...
```
- Optimization should be enabled in the IDE, otherwise the project will not fit into 64K flash memory if EEPROM emulation is enabled (it takes 99,67% flash without space for EEPROM emulation). 
